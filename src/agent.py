...
from model import Linear_QNet, QTrainer, board_net, CNNQNet
...
models = [Linear_QNet(12, 256, 4), board_net(100, 256, 4),CNNQNet(4, 512, 4) ]
state_functions = [get_state, get_state_2, get_state_3]
...
def train():
    ...
    while True:
        ...
        state_new = agent.state_function(game.game)
